...
class Container_afafa48cca extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				[
					'message' => '#unknown interface Filament\\\Contracts\\\Plugin#',
					'path' => '/Users/fadymondy/Sites/laravilt/packages/plugins/src/Contracts/Plugin.php',
				],
				[
					'message' => '#invalid type Filament\\\Panel#',
					'path' => '/Users/fadymondy/Sites/laravilt/packages/plugins/src/Contracts/Plugin.php',
				],
			],
			true
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_afafa48cca $container)
			{
	...
	public function createServiceContainer(): Container_afafa48cca
	{
		return $this;
	}
