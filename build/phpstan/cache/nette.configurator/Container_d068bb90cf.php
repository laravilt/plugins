...
class Container_d068bb90cf extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			['#unknown interface Filament\\\Contracts\\\Plugin#', '#invalid type Filament\\\Panel#'],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_d068bb90cf $container)
			{
	...
	public function createServiceContainer(): Container_d068bb90cf
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'ignoreErrors' => ['#unknown interface Filament\\\Contracts\\\Plugin#', '#invalid type Filament\\\Panel#'],
