...
class Container_d69fd6e590 extends _PHPStan_b22655c3f\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_d69fd6e590 $container)
			{
	...
	public function createService082(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			...
			[],
			[
				'analyseAndScan' => ['/Users/fadymondy/Sites/laravilt/packages/plugins/src/Contracts/Plugin.php'],
				'analyse' => [],
			]
		);
	}
	...
	public function createServiceContainer(): Container_d69fd6e590
	{
		return $this;
	}
